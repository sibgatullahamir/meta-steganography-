...
public class EmbedMessageGUI extends JFrame implements ActionListener, ItemListener
{
	...
	{
		super("Embedding message - Steganography");
		...
		lblStatus= new MyJLabel("Minimum required size of the Master file: 32Kb | © Sibgatullah Amir ", arialFont, Color.black, Color.lightGray);
